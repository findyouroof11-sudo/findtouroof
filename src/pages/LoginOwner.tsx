...
const LoginOwner: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
      ...
      {/* Professional Interior Background Simulation */}
      <div className="absolute inset-0">
        {[...Array(15)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute bg-magenta-400/10 rounded-lg"
            style={{
      ...
      >
        <div className="glass-effect backdrop-blur-xl bg-white/10 dark:bg-gray-900/20 rounded-3xl border border-white/20 p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            >
              MANAGE YOUR <span className="text-magenta-400">LISTINGS</span>
            </motion.h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              ...
              <div className="text-center">
                ...
                >
                  Don't have an account? Start listing →
                </Link>
              </div>
              ...
              <div className="text-center">
                ...
                >
                  Are you looking for a home? Login here
                </Link>
              </div>
            </motion.div>
          </form>
